...
FlightsFootprintCore.prototype.createMark = function(depart,arrive){
    ...
    e.innerHTML = "<a href=\'\' target=\'_blank\' title=\'Outbound :" +
        depart + "kg of CO" +"2".sub()+  "e per person.\nReturn :"+ arrive + "kg of CO<sub>2</sub>"+"e per person." + '\' class=\'carbon\' id=\'carbon\'>' +parseInt(arrive+depart)+ " kg of CO" +"2".sub()+ " per person" +
